...
# import Visium data
Ant_Sec1 <- importVisium("../data/Mouse_Brain/Sagittal_Anterior/Section1/",
                         sample_name = "Anterior1")
Pos_Sec1 <- importVisium("../data/Mouse_Brain/Sagittal_Posterior/Section1/",
...
allen_reference <- readRDS("../data/Mouse_Brain/scRNA_Mouse_Brain/allen_cortex_analyzed_subset.rds")
...
# (OPTIONAL) deconvolute spots, but you can skip this as it is lengthy in time
...
MBrain_Sec <- readRDS("../data/Mouse_Brain/MBrain_Sec_decon.rds")
...
annotations <- read.table("../data/BreastCancer/Xenium_R1/annotation.txt")[,1]
